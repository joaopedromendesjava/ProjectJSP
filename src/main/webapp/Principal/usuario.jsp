...
<body>
													...
													<form class="form-material" enctype="multipart/form-data"  action="<%=request.getContextPath()%>/ServletUsuarioController" method="post" id="formUser">	
														...
														<div class="form-group form-default input-group mb-4">
																<div class="input-group-prepend">
																	...
																	<c:if test="${modolLogin.fotouser == '' || modolLogin.fotouser == null }">
																		<img alt="Imagem user" id="fotoembase64" src="assets/images/user.png" width="90px">
																	</c:if>
														...
														<div class="form-group form-default form-static-label">
															<input type="text" name="complemento" id="complemento" class="form-control" required="required" autocomplete="off" value="${modolLogin.complemento}">
															<span class="form-bar"></span> 
														...
														<div class="form-group form-default form-static-label">
															...
															<span class="form-bar">
															</span> <label class="float-label">Senha</label>
														</div>
	...
	<script type="text/javascript">
		...
		function visualizarImg(fotoembase64, fileFoto){
			...
			var preview = document.getElementById(fotoembase64); // campo Imagem HTML
